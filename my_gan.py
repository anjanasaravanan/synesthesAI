...
def train(dataset, epochs):
    ...
    generator.save_weights('SAVED_WEIGHTS')
...
def generate_and_save_images(model, epoch, test_input):
    ...
    predictions = tf.linalg.normalize(predictions, axis=3)[0] 
...
def post_processing():
    ...
    noise_sampler = np.load('postprocessing/chp_op31_batched_wav.npy', allow_pickle=True)
...
def video_processing():
    ...
    input_file = np.load('postprocessing/chp_op31_batched_wav.npy', allow_pickle=True)
